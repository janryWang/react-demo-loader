...
var compileElement = function compileElement(ast) {
  if (ast.type === "element") {
    return "React.createElement(" + (ast.isComponent ? ast.tagName : "\"" + ast.tagName + "\"") + ",{" + compileAttributes(ast.tagName, appendClassName(ast.tagName, ast.properties)) + "}" + (ast.children.length ? "," + ast.children.map(function (node) {
