...
var createMacroElement = function createMacroElement(node, opts) {
  if (node.value[1] === 'COMPONENT_PROPS' && node.value[2]) {
    renderTablePropsToFile(opts.resourcePath, path.resolve(path.dirname(opts.resourcePath), node.value[2]), node.position.end.offset, node.position.after.start.offset);
